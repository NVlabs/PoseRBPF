...
import torch
import numpy as np
from utils.posecnn_layer.sdf_matching_loss import SDFLoss

class sdf_multiple_optimizer():
    def __init__(self, classes, sdf_files, reg_trans=100.0, reg_rot=0.1, optimizer='Adam', use_gpu=True):
        ...
        self.SDF_TRANSLATION_REG = reg_trans
        self.SDF_ROTATION_REG = reg_rot
    ...
    def refine_pose_layer(self, T_oc_0, points, steps=10):
        ...
        treg = self.SDF_TRANSLATION_REG
        rreg = self.SDF_ROTATION_REG
